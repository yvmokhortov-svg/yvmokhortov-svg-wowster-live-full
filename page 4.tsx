...
export default function LoginPage() {
  ...
  return (
    <div className="mx-auto max-w-xl rounded-xl border border-[var(--line)] bg-white p-6">
      ...
      <div className="mt-4 space-y-1 text-center text-sm text-[var(--text-soft)]">
        <p>
          New student?{" "}
          <Link className="text-[var(--brand-blue)]" href="/register-user">
            Sign up as user
          </Link>
        </p>
        <p>
          New artist?{" "}
          <Link className="text-[var(--brand-blue)]" href="/register-artist">
            Sign up as artist
          </Link>
        </p>
      </div>
